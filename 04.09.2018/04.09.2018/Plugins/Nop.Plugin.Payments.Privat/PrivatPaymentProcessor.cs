...
using Nop.Plugin.Payments.Privat.Validators;
...
namespace Nop.Plugin.Payments.Privat
{
    ...
    public class PrivatPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private readonly PrivatPaymentSettings _PrivatPaymentSettings;
        ...
        public ProcessPaymentResult ProcessPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            switch (_PrivatPaymentSettings.TransactMode)
            {
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/PaymentPrivat/Configure";
        }
